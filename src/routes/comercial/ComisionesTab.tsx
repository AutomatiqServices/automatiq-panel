      ...
      <Card className="p-5">
        ...
        {sales.length === 0 ? (
          ...
          <div className="flex flex-col gap-2">
            {sales.map((s) => (
              <div key={s.id} className="grid grid-cols-[36px_1fr_auto_auto] items-center gap-3 rounded-lg border p-3">
                ...
                <div>
                  <div className="text-sm font-semibold">{s.client_name}</div>
                ...
                <div className="text-right">
                  ...
                  <div className="text-sm font-bold text-emerald-500">{fm(s.cobrada)}</div>
                </div>
                <div className="text-right">
                  <div className="text-[10px] text-muted-foreground">Por cobrar</div>
                  <div className="text-sm font-bold text-amber-500">{fm(s.pendiente)}</div>
                </div>
              </div>
            ))}
          </div>
